import { BRANDING_LOGO_URL, BUILT_IN_DEFAULT_AGENT_DISPLAY_NAME } from '@lobechat/business-const';
...
export const DEFAULT_INBOX_TITLE = BUILT_IN_DEFAULT_AGENT_DISPLAY_NAME;
