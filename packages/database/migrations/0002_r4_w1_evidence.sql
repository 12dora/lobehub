...
-- DROP+recreate: IF NOT EXISTS would leave the old single-arm predicate in place.
DROP INDEX IF EXISTS "platform_audit_exports_purge_storage_key_expr_idx";
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "platform_audit_exports_purge_storage_key_expr_idx"
