export default {
  ...
  'agent.layout.mode.agent': 'Conversational setup',
  'agent.layout.mode.classic': 'Manual setup',
  ...
  'agent.layout.switchMessage':
    'Prefer a different setup method? Switch to <modeLink><modeText>{{mode}}</modeText></modeLink> or <skipLink><skipText>{{skip}}</skipText></skipLink>.',
  'agent.layout.switchMessageClassic':
    'Prefer a different setup method? Switch to <modeLink><modeText>{{mode}}</modeText></modeLink>.',
