export default {
  ...
  'ModelSelect.staleModel.notEnabled.managedHint':
    'This model is not enabled. Model availability is managed by your organization; choose another model if needed.',
  'ModelSelect.staleModel.notEnabled.managedTooltip':
    'This model is not enabled and its availability is managed by your organization.',
