export default {
  ...
  'askUserQuestion.escape.enter': 'Or type directly',
  ...
  'connector.add.advanced': 'Advanced settings',
  'connector.add.authError': 'Authorization failed: {{reason}}',
  'connector.add.authFailed':
    'Could not connect. This server may require an OAuth client ID in advanced settings.',
  'connector.add.cancel': 'Cancel',
  'connector.add.cancelled': 'Authorization was not completed',
  'connector.add.clientId': 'OAuth client ID (optional)',
  'connector.add.clientSecret': 'OAuth client secret (optional)',
  'connector.add.confirm': 'Add',
  'connector.add.editTitle': 'Edit connector',
  'connector.add.name': 'Name',
  'connector.add.namePlaceholder': 'My connector',
  'connector.add.popupBlocked': 'Allow pop-ups for this site and try again.',
  'connector.add.redirectHint': 'Redirect URI to register with your OAuth app:',
  'connector.add.success': 'Connector connected',
  'connector.add.syncFailed': 'Authorized, but tools could not be synced. Use Sync to retry.',
  'connector.add.title': 'Add custom connector',
  'connector.add.unknownError': 'unknown error',
  'connector.add.update': 'Save',
  'connector.add.url': 'Remote MCP server URL',
  'connector.connected': 'Connected',
  'connector.createTools': 'Create tools',
  'connector.delete': 'Delete',
  'connector.deleteConfirm': 'Delete this connector?',
  'connector.deleteTools': 'Delete tools',
  'connector.disconnect': 'Disconnect',
  'connector.edit': 'Edit',
  'connector.edit.success': 'Connector updated',
  'connector.migrate.noEndpoint':
    'This custom plugin is missing a URL (HTTP) or a command (stdio).',
  'connector.migrate.noMcp': 'This custom plugin has no MCP configuration to migrate.',
  'connector.migrate.unsupportedTransport': 'This custom plugin uses an unsupported transport.',
  'connector.noTools': 'No tool permissions to configure.',
  'connector.notConnected': 'Not connected',
  'connector.permission.approvalAll': 'All need approval',
  'connector.permission.approvalHint': 'Needs approval before each call',
  'connector.permission.autoAll': 'All auto',
  'connector.permission.autoHint': 'Auto — called directly by AI',
  'connector.permission.custom': 'Custom',
  'connector.permission.disableAll': 'All disabled',
  'connector.permission.disabledHint': 'Disabled — hidden from AI',
  'connector.readOnlyTools': 'Read-only tools',
  'connector.refresh': 'Refresh',
  'connector.resetPermissions': 'Reset permissions',
  'connector.sync': 'Sync',
  'connector.title': 'Connectors',
  'connector.uninstall': 'Uninstall',
  'connector.uninstallConfirm': 'Uninstall this tool?',
  'connector.updateTools': 'Update tools',
