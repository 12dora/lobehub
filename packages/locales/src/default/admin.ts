export default {
  ...
  'system.documentRender.queue': '{{pending}} pending / {{running}} running',
  'system.documentRender.sidecar': 'Sidecar configured: {{value}}',
  'system.documentRender.version': 'Version: {{version}}',
  'system.sandbox.containers': '{{active}} / {{max}} containers',
  'system.sandbox.daemon': 'Daemon: {{value}}',
  'system.sandbox.image': 'Image: {{value}}',
  ...
  'system.values.dependencyError.passive_check_only': 'Configured; not actively checked.',
