export default {
  ...
  'agentCatalog.editor.conflict':
    'Someone else saved this assistant while you were editing. Close this window and reopen it to load the latest version.',
  ...
  'aiServiceModel.page.desc':
    'Platform default models for new agents and system helpers. Users can override them in their own settings.',
  ...
  'aiProviderSettings.sharedOAuth.disconnectConfirm':
    'Disconnect the shared {{name}} account? It is removed from this platform and the provider is turned off for every member. Connecting an account again does not turn it back on — an administrator has to enable the provider explicitly. This does not revoke the account at {{name}}: do that in its own console if you need to.',
  ...
  'aiProviderSettings.sharedOAuth.enforcementHint':
    'Members are not using this shared account yet — it only takes effect once Managed resources → Providers is set to Platform managed.',
  ...
  'aiSkillSettings.description':
    'Manage the skills the platform provides. Listed skills are available to every user.',
  ...
  'aiConnectorSettings.draftBanner.desc':
    'Run “Discover tools” and enable at least one tool before publishing.',
  ...
  'aiConnectorSettings.description':
    'Manage the connectors the platform provides. Listed connectors are available to every user; personal authorizations stay with each account.',
  ...
  'creds.page.desc':
    'Credentials the platform holds on behalf of all users. Secrets are stored encrypted and never shown again after saving.',
  ...
  'overview.scope.note':
    'Active users and message / topic / agent counts cover {{scope}}. Total users is all-time.',
  ...
  'skillCatalog.actions.archive.desc': 'Archive this skill.',
  ...
  'skillCatalog.actions.save.desc': 'Save the skill’s basic information.',
  ...
  'skillCatalog.actions.validate.desc': 'Validate the selected version and its dependencies.',
  ...
  'users.list.filters.source': 'Source',
  ...
  'users.modals.bulk.more': '+{{count}} more',
  'users.modals.bulk.preview': '{{count}} selected: {{names}}',
  ...
  'users.modals.roles.desc': 'Set this user’s global roles.',
  ...
  'users.modals.roles.lastSuperNote': 'At least one permanent super administrator must remain.',
  ...
  'users.danger.desc':
    'Irreversible or high-risk account actions. You will be asked to verify your identity first.',
  ...
  'connectorCatalog.mutations.discover.description':
    'Connect to the service and refresh the tool list.',
  'connectorCatalog.mutations.discover.title': 'Discover Connector tools',
  'connectorCatalog.mutations.publish.description': 'Publish this connector so users can use it.',
  ...
  'connectorCatalog.mutations.save.description':
    'Save the configuration. Credentials are replaced only when a new value is entered.',
  'connectorCatalog.mutations.save.title': 'Save Connector draft',
  'connectorCatalog.mutations.test.description':
    'Test the connection with the currently saved configuration.',
  ...
  'branding.fields.primaryColorHint':
    'Applied as the platform default primary colour after saving; members can still override it in their own settings.',
  ...
  'branding.fields.rebuildRequired':
    'Saving web branding does not rename or rebuild an installed desktop app.',
  ...
  'branding.save.description': 'After saving, everyone will see the branding configured here.',
  'branding.save.impact':
    'Web surfaces refresh right away. Desktop package fields still need a rebuild.',
  'branding.save.title': 'Save branding',
  ...
  'identityProviders.save.draftSaved': 'Saved.',
  ...
  'identityProviders.save.description':
    'Save this configuration. The live sign-in method does not change until you publish.',
  'identityProviders.save.success': 'Saved.',
  'identityProviders.save.title': 'Save sign-in method',
  ...
  'identityProviders.revision': 'Version {{revision}}',
  ...
  'identityProviders.values.providerStatus.active': 'Enabled',
  'identityProviders.values.providerStatus.archived': 'Archived',
  'identityProviders.values.providerStatus.disabled': 'Disabled',
  'identityProviders.values.providerStatus.draft': 'Pending configuration',
  'identityProviders.values.providerStatus.error': 'Error',
  'identityProviders.values.providerStatus.pending_restart': 'Restart pending',
  'identityProviders.values.providerStatus.published': 'Restart pending',
  ...
  'identityProviders.values.restartReason.no_pending_restart': 'no configuration awaits activation',
  ...
  'identityProviders.values.source.break_glass': 'Emergency configuration',
  'identityProviders.values.source.database': 'Database',
  'identityProviders.values.source.environment': 'Environment variables',
  'identityProviders.values.source.lkg': 'Last known good configuration',
  ...
  'system.domains.description':
    'Compare the published configuration with what each instance has loaded.',
  'system.domains.empty': 'No convergence domains were reported.',
  'system.domains.title': 'Configuration sync',
  ...
  'system.instances.description':
    'Each running service process registers as an instance and reports a heartbeat regularly; no heartbeat for 90 seconds means it is offline.',
  'system.instances.empty': 'No service instance is currently live.',
  'system.instances.emptyAll': 'No service instance has registered yet.',
  'system.instances.emptyOffline': 'No offline instance is recorded.',
  ...
  'system.oidc.activeRevision': 'Active version',
  ...
  'system.status.loadFailedDescription':
    'Dependency health and summary counts are unavailable. Please retry.',
  ...
  'system.values.oidcSource.database': 'Database',
  'system.values.oidcSource.disabled': 'Disabled',
  'system.values.oidcSource.environment': 'Environment variables',
  'system.values.oidcSource.lkg': 'Last known good configuration',
  ...
  'systemGeneral.test.reason.configured_unverified': 'Configured (could not verify online)',
  ...
  'systemGeneral.edit.saveRejected': 'The server rejected this value.',
  ...
  'systemGeneral.failOpen.description':
    'The saved admin configuration is not in effect (it could not be decrypted or loaded); environment variables are being used. Re-enter the secret and save, or revert to environment variables.',
  ...
  'audit.logs.action.admin.agents.save': 'Save assistant',
  ...
  'taskTemplateCatalog.actions.enable': 'Enable',
  'taskTemplateCatalog.actions.disable': 'Disable',
  'taskTemplateCatalog.actions.delete': 'Delete',
  'taskTemplateCatalog.actions.retry': 'Retry',
  'taskTemplateCatalog.list.columns.template': 'Template',
  ...
  'taskTemplateCatalog.list.empty.default':
    'No task templates yet. Import the built-in recommendations to start managing them, or create your own.',
  ...
  'taskTemplateCatalog.form.time': 'Time',
  ...
  'taskTemplateCatalog.form.cronHint':
    'Five fields: minute hour day month weekday. Day and month must stay "*".',
  ...
  'taskTemplateCatalog.form.connectorSource': 'Source',
  'taskTemplateCatalog.form.connectorRequired': 'Required before the task can be created',
  ...
  'contentModeration.records.sectionDisposition': 'Disposition',
  ...
  'contentModeration.errors.downgradeIncomplete':
    'Pick both a provider and a model for the downgrade target, or clear it.',
  ...
  'contentModeration.toast.testFailed': 'The test run failed.',
  ...
  'contentModeration.errors.field.range': 'The selected time range was rejected.',
