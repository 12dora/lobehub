export default {
  ...
  'nav.auditConversations': 'Conversation evidence',
  'nav.auditConversationUser': 'User evidence',
  'nav.auditConversationTopic': 'Conversation detail',
  'nav.auditExports': 'Evidence exports',
  'nav.auditLegalHolds': 'Legal holds',
  'nav.auditRetention': 'Retention',
  ...
  'audit.conversations.page.title': 'Conversation evidence',
  ...
  'audit.conversations.user.title': 'User evidence',
  ...
  'audit.conversations.disabled.title': 'Conversation evidence is disabled by policy',
  'audit.conversations.disabled.desc':
    'Content access mode is set to disabled. Open Retention to adjust the audit policy if you have permission.',
  'audit.conversations.disabled.goRetention': 'Open retention settings',
  ...
  'audit.exports.download.toast':
    'Download started · {{bytes}} · checksum {{checksum}} · link valid about 5 minutes',
  ...
  'audit.holds.page.title': 'Legal holds',
  'audit.holds.page.desc': 'Prevent retention cleanup from deleting protected evidence scopes.',
  'audit.holds.empty': 'No legal holds yet.',
  ...
  'audit.holds.actions.create': 'New hold',
  'audit.holds.actions.release': 'Release',
  'audit.holds.create.title': 'Create legal hold',
  'audit.holds.create.warning':
    'While a hold is active, matching evidence is skipped by retention cleanup and is not deleted.',
  ...
  'audit.holds.create.submit': 'Create hold',
  'audit.holds.create.reasonDesc': 'Describe why this evidence must be preserved.',
  'audit.holds.create.scopeIdRequired': 'Scope ID is required for this scope type.',
  'audit.holds.release.title': 'Release legal hold',
  'audit.holds.release.desc':
    'After release, retention cleanup may delete matching evidence again.',
  'audit.holds.release.impact':
    'This does not delete data immediately — it only removes the hold protection.',
  'audit.holds.release.submit': 'Release hold',
  'audit.retention.page.title': 'Retention governance',
  ...
  'audit.retention.policy.redactionProfile': 'Redaction profile',
  ...
  'audit.retention.cleanup.executeDesc':
    'Permanently delete evidence past retention. Legal holds are skipped.',
  'audit.retention.cleanup.executeImpact':
    'Deletes cannot be undone. Items under legal hold are skipped.',
  'audit.retention.cleanup.executeConfirm':
    'This permanently deletes data past the retention cutoff. Legal holds will be skipped. Continue?',
  ...
  'audit.retention.scope.conversations': 'Conversations',
  ...
  'audit.retention.runs.skippedHold': 'Skipped hold: {{count}}',
  'audit.retention.runs.skippedHoldLabel': 'Skipped legal hold',
  ...
  'audit.live.messages.openEvidence': 'Open in Conversation Evidence',
