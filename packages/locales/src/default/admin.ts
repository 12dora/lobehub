export default {
  ...
  'aiProviderSettings.sharedOAuth.disconnectConfirm':
    'Disconnect the shared {{name}} account? It is removed from this platform and the provider is turned off for every member; after reconnecting, the provider must be enabled again manually. This does not revoke the authorization at {{name}} — do that in its own console if needed.',
  ...
  'aiProviderSettings.sharedOAuth.disconnectSuccess':
    'Account disconnected. This provider is turned off for all members.',
  ...
  'modules.description':
    'Turning off modules you do not use lowers memory and background work. Most changes take effect once you reload the page; modules tagged “needs restart” only free their resources after the service restarts.',
  ...
  'modules.groups.fork': 'Platform features',
  'modules.groups.upstream': 'Upstream features',
  ...
  'modules.presets.custom.desc': 'Your selection matches none of the presets.',
  'modules.presets.custom.title': 'Custom',
  'modules.presets.full.desc': 'Everything on — the current default.',
  'modules.presets.full.title': 'Full',
  'modules.presets.minimal.desc':
    'Core plus the lightweight platform features. Sized for 2 cores / 4 GB.',
  'modules.presets.minimal.title': 'Small machine',
  'modules.presets.standard.desc':
    'Adds audit, content moderation, network proxy and the commonly used upstream features. Sized for 4 cores / 8 GB.',
  ...
  'modules.summary.perMessage': 'Per-message / per-fetch work',
  ...
  'modules.tags.idleRss': '≈ {{mb}} MB',
  'modules.tags.loadKind.onUse': 'When used',
  'modules.tags.loadKind.perFetch': 'Per outbound fetch',
  'modules.tags.loadKind.perMessage': 'Per message',
  'modules.tags.loadKind.perRequest': 'Per request',
  'modules.tags.loadSensitive': 'Load sensitive',
  'modules.tags.restart': 'Needs restart',
  'modules.tags.subprocess': 'Subprocess',
  'modules.title': 'Modules',
  'modules.wizard.back': 'Back',
  'modules.wizard.finish': 'Finish',
  'modules.wizard.finishDesc': 'You can change modules any time under System → Modules.',
