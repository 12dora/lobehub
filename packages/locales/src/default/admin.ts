export default {
  ...
  'agentCatalog.list.empty.default': 'No platform assistants yet.',
  ...
  'aiProviderSettings.sharedOAuth.enforcementHint':
    'This shared account is not in effect for members yet: set Managed resources → Providers to Platform managed.',
  'aiProviderSettings.sharedOAuth.enforcementHintLink': 'Open managed resources',
  ...
  'aiProviderSettings.sharedOAuth.success.pendingTakeover':
    'Account connected. Members will use it once Managed resources → Providers is set to Platform managed.',
  ...
  'system.values.domain.managed_policy': 'Managed resources',
  ...
  'modules.items.managedAgents.title': 'Platform assistants',
