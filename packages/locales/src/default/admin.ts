export default {
  ...
  'audit.exports.kind.operation_logs': 'Operation logs',
  'audit.exports.kind.conversations': 'Conversations',
  'audit.exports.kind.user_timeline': 'User timeline',
  'audit.exports.kindDesc.operation_logs': 'Export filtered platform operation events.',
  'audit.exports.kindDesc.conversations':
    'Export conversation metadata (and bodies when allowed) for one user.',
  'audit.exports.kindDesc.user_timeline': 'Export a user activity timeline.',
  'audit.exports.download.title': 'Download export',
  'audit.exports.download.desc':
    'A short-lived signed URL will open. Confirm your reason for the audit trail.',
  'audit.exports.download.submit': 'Download',
  'audit.exports.download.toast':
    'Download started · {{bytes}} · checksum {{checksum}} · link valid ~5 minutes',
  ...
  'audit.exports.create.title': 'Create export',
  'audit.exports.create.pickKind': 'What do you want to export?',
  'audit.exports.create.next': 'Next',
  'audit.exports.create.back': 'Back',
  'audit.exports.create.continueReason': 'Continue with reason',
  'audit.exports.create.submit': 'Create export',
  'audit.exports.create.reasonDesc': 'This export request will be recorded with your reason.',
  'audit.exports.create.timeRange': 'Time range',
  'audit.exports.create.action': 'Action filter (optional)',
  'audit.exports.create.user': 'User',
  'audit.exports.create.topicId': 'Topic ID (optional)',
  'audit.exports.create.titleKeyword': 'Title keyword (optional)',
  'audit.exports.create.includeBodies': 'Include message bodies',
  'audit.exports.create.includeBodiesDisabled': 'Policy does not allow message bodies in exports.',
  'audit.exports.create.includeBodiesHint': 'Bodies are credential-masked. Access is audited.',
