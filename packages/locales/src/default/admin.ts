export default {
  ...
  'agentCatalog.list.description':
    'Create and edit the assistants your members use. Saving takes effect immediately for everyone assigned.',
  ...
  'aiProviderSettings.description':
    'Manage global platform AI providers. Every change applies immediately for all members.',
  ...
  'branding.description':
    'Edit the {{platformName}} name, assets, and links. Saving applies them to everyone right away.',
  ...
  'branding.fields.immediate': 'Takes effect immediately after saving.',
  ...
  'branding.preview.description':
    'This preview stays on this page. Saving is what applies these values to everyone.',
  ...
  'system.instances.description':
    'Every application process registers one instance record and reports a heartbeat every 30 seconds. No heartbeat for 90 seconds means the process is offline. Older rows are leftovers from past restarts.',
  ...
  'taskTemplateCatalog.list.filters.enabled': 'Status',
