export default {
  ...
  'system.jobs.committedRefreshFailed':
    'The write committed, but refreshed job state could not be confirmed. Affected rows remain locked until refresh succeeds.',
  ...
  'system.jobs.modal.cancel.completedItems':
    'Completed items remain committed. Cancellation stops future idempotent work only.',
  'system.jobs.modal.cancel.description':
    'Request cancellation for job {{jobId}}. The current atomic batch may finish first.',
  'system.jobs.modal.cancel.title': 'Cancel this job?',
  'system.jobs.modal.reason': 'Audit reason',
  'system.jobs.modal.reasonPlaceholder': 'Explain why this operation is needed',
  'system.jobs.modal.reasonRequired': 'Enter an audit reason before continuing.',
  'system.jobs.modal.retry.description':
    'Retry the supported failed work for job {{jobId}} using its current server revision.',
  ...
  'system.jobs.summaryTitle': 'Job summary',
  'system.jobs.summaryUnavailable':
    'Job aggregates are unavailable. No zero values are shown because they would be misleading.',
  ...
  'system.oidc.title': 'OIDC runtime',
  ...
  'system.publishFailures.unavailable':
    'Publish failure history is unavailable. An empty state would be misleading.',
  'system.snapshotAt': 'Snapshot time',
  ...
  'system.values.jobKind.agent_rollout': 'Agent rollout',
  'system.values.jobKind.connector_runtime': 'Connector runtime',
  'system.values.jobKind.easyauth_sync': 'EasyAuth sync',
  'system.values.jobKind.secret_rewrap': 'Secret re-wrap',
  ...
  'system.values.status.dead': 'Dead',
  ...
  'system.values.status.reserved': 'Reserved',
