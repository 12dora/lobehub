export default {
  ...
  'aiProviderSettings.sharedOAuth.success.publishFailed':
    'Account connected, but the provider could not go live ({{code}}). Use the draft banner at the top of this page to review and publish it.',
