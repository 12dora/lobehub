export default {
  ...
  'bedrock.authMode.title': 'Authentication',
  'bedrock.checker.desc': 'Test whether the Bedrock authentication details are correct',
  ...
  'bedrock.unlock.description':
    'Enter your Amazon Bedrock API key or AWS credentials to start the session. The app will not store your authentication configuration',
  'bedrock.unlock.imageGenerationDescription':
    'Enter your Amazon Bedrock API key or AWS credentials to start generating. The application will not store your authentication credentials.',
  ...
  'providerModels.config.oauth.paste.detected.session':
    'Detected: web session — this renews itself.',
  'providerModels.config.oauth.paste.detected.unknown':
  ...
  'providerModels.config.oauth.paste.errors.deviceMismatch':
  ...
  'providerModels.config.oauth.paste.errors.sessionInvalid':
  ...
  'providerModels.config.oauth.paste.openChatGPT': 'Open chatgpt.com',
  'providerModels.config.oauth.paste.openSessionPage': 'Open /api/auth/session',
  'providerModels.config.oauth.paste.pasteSession': 'Paste a web session',
  ...
  'providerModels.config.oauth.paste.sessionQuickTry':
  ...
  'providerModels.config.oauth.paste.sessionStep1':
    '1. Sign in at chatgpt.com in a browser (open it on the right).',
  'providerModels.config.oauth.paste.sessionStep2':
  ...
  'providerModels.config.oauth.paste.sessionStep3':
  ...
  'providerModels.config.sharedOAuth.perUserOnlyNotice':
    '{{name}} is connected per member from their own provider settings. Platform hosting would need a service credential, which {{name}} does not issue for shared use.',
  'providerModels.config.sharedOAuth.tag': 'Shared account',
  ...
  'providerModels.list.syncUpstream.action': 'Sync upstream models',
  'providerModels.list.syncUpstream.empty': 'Upstream returned no models',
