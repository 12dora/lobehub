export default {
  ...
  'moderation.category.hate_harassment': 'Hate & harassment',
  'moderation.category.illicit': 'Illegal activity',
  'moderation.category.jailbreak': 'Jailbreak & prompt injection',
  'moderation.category.other': 'Other violation',
  'moderation.category.political': 'Politically sensitive',
  'moderation.category.privacy': 'Privacy & personal data',
  'moderation.category.self_harm': 'Self-harm',
  'moderation.category.sexual': 'Sexual',
  'moderation.category.sexual_minors': 'Sexual content involving minors',
  'moderation.category.violence': 'Violence & gore',
  'moderation.categoryLabel': 'Category: {{category}}',
  'addNew': 'Add new',
  'gotIt': 'Got it',
  'more': 'More',
  ...
  'tab.chat': 'Chat',
  'recents': 'Recents',
  'recentsDelete.confirm.desc.24h':
    'Every conversation updated in the last 24 hours will be permanently deleted, along with all of its messages. This cannot be undone.',
  'recentsDelete.confirm.desc.7d':
    'Every conversation updated in the last 7 days will be permanently deleted, along with all of its messages. This cannot be undone.',
  'recentsDelete.confirm.desc.30d':
  ...
  'recentsDelete.range.7d': 'Last 7 days',
  'recentsDelete.range.30d': 'Last 30 days',
  'recentsDelete.range.all': 'All',
  'recentsDelete.success': 'Deleted {{count}} conversations',
  'recentsDelete.trigger': 'Delete conversations',
  ...
  'userPanel.adminConsole': 'Admin console',
