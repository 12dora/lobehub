export default {
  ...
  'config.quality.options.auto': 'Auto',
  'config.quality.options.hd': 'High Definition',
  'config.quality.options.high': 'High',
  'config.quality.options.low': 'Low',
  'config.quality.options.medium': 'Medium',
  ...
  'notSupportGuide.desc':
    'The current deployment mode does not support AI image generation. Switch to the <1>server database deployment mode</1>, or use <3>{{platformName}} Cloud</3>.',
