export default {
  ...
  'messenger.linkModal.instructions':
    'Open the bot, send /start, then tap "Link Account" to connect your {{appName}} account.',
  ...
  'messenger.slack.connectModal.description':
    'You will be redirected to Slack to authorize the {{appName}} workspace install.',
  ...
  'messenger.slack.connections.disconnectConfirm':
    'Disconnect the {{appName}} bot from this Slack workspace? Existing user links will pause until you re-install.',
  ...
  'messenger.slack.installBlocked.suggestion':
    "DM the bot on Slack to link your personal account — you don't need to install again. Or ask the original installer to disconnect this workspace first if you want to take over ownership.",
  'messenger.slack.installBlocked.title': 'Workspace already connected',
  'messenger.slack.installBlocked.withName':
    '"{{workspace}}" is already connected to {{appName}} by another user.',
  'messenger.slack.installBlocked.withoutName':
    'This Slack workspace is already connected to {{appName}} by another user.',
  ...
  'messenger.discord.connectModal.description':
    'Add the {{appName}} bot to a Discord server you manage.',
  ...
  'messenger.discord.installBlocked.suggestion':
    "DM the bot on Discord to link your personal account — you don't need to add the bot again. Or ask the original installer to remove this server in {{appName}} Settings → Messenger before re-adding it.",
  ...
  'messenger.discord.installBlocked.withoutName':
    'This Discord server is already connected to {{appName}} by another user.',
  ...
  'messenger.list.slack.description':
    'Chat with your {{appName}} agents on Slack by DMing or mentioning the bot in any workspace.',
  'messenger.list.telegram.description':
    'Chat with your {{appName}} agents on Telegram, and choose which agent replies.',
  'messenger.setActiveFailed': 'Failed to set as active.',
  'messenger.setActiveSuccess': 'Active agent updated.',
  'messenger.subtitle':
    'Connect your account to the official {{appName}} bot once. Pick which agent receives messages, switch any time from here or from the bot.',
  'messenger.title': 'Messenger',
  'messenger.unlinkConfirm':
    'Disconnect your {{platform}} account from {{appName}}? Inbound messages will stop until you /start again.',
  ...
  'verify.confirm.conflict.description':
    'This {{platform}} account is already linked to {{appName}} account {{email}}. Sign in to that account to manage the link, or unlink there before retrying.',
  ...
  'verify.confirm.fields.lobeHubAccount': '{{appName}} account',
  'verify.confirm.fields.platformAccount': '{{platform}} account',
  'verify.confirm.fields.workspace': 'Workspace',
  'verify.confirm.noAgents':
    "You don't have any agents yet. Create one in {{appName}}, then come back to finish linking.",
  'verify.confirm.relink.description':
    'This {{appName}} account is already linked to {{platform}} account {{account}}. To link a different {{platform}} account, disconnect the current one first in Settings → Messenger.',
  ...
  'verify.error.alreadyConsumed':
    'This link has already been used to connect an account. Sign in to that {{appName}} account to manage the connection, or return to the bot and send /start again to issue a new link.',
  'verify.error.alreadyConsumedTitle': 'This link is already used',
  'verify.error.alreadyLinkedToOther':
    'This account is already linked to a different {{appName}} account. Sign in to that account first.',
