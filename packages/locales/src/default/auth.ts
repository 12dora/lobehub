export default {
  ...
  'profile.security.passkey.desc':
    "Sign in with your device's fingerprint, face or PIN — no password to type.",
  'profile.security.passkey.empty': 'No passkeys yet',
  'profile.security.passkey.error': 'Could not add the passkey. Try again.',
  ...
  'profile.security.passkey.removeConfirm':
  ...
  'profile.security.password.incorrect': 'That current password is not correct',
  'profile.security.password.mismatch': 'The two new passwords do not match',
  'profile.security.password.newLabel': 'New password',
  'profile.security.password.reuse': 'The new password must be different from the current one',
  'profile.security.password.revokeOthers': 'Sign out of all other devices',
  ...
  'profile.security.password.useEmailReset': 'Forgot your current password? Reset it by email',
  ...
  'profile.security.twoFactor.backupCodes.desc':
    'Each code works once. Keep them somewhere safe — if you lose your authenticator, this is the only way back into your account.',
  ...
  'profile.security.twoFactor.ssoHint':
    'Accounts that sign in through your organization’s identity provider have their second factor managed there.',
  ...
  'profile.security.twoFactor.subtitle':
    'Ask for a second proof of identity at sign-in, so a stolen password is not enough on its own.',
  'profile.security.twoFactor.title': 'Two-step verification',
  'profile.security.twoFactor.totp.codeHint': 'Enter the code your authenticator shows right now.',
  'profile.security.twoFactor.totp.codeLabel': '6-digit code',
  'profile.security.twoFactor.totp.desc':
    'A 6-digit code from an app like Google Authenticator or 1Password.',
  'profile.security.twoFactor.totp.disableConfirm': 'Turn off',
  'profile.security.twoFactor.totp.disableDesc':
    'Your password alone will be enough to sign in, and your recovery codes stop working.',
  ...
  'profile.security.twoFactor.totp.scanHint':
    'Scan this with your authenticator app. If you cannot scan it, enter the key by hand.',
