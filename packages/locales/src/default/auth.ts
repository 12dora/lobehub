export default {
  ...
  'authModal.description':
    'Your sign-in session has expired. Please sign in again to continue using cloud sync features.',
  ...
  'betterAuth.signin.passkey.action': 'Sign in with a passkey',
  'betterAuth.signin.passkey.error': 'Passkey sign-in failed. Try again, or use your password.',
  'betterAuth.signin.passkey.unsupported': 'This browser does not support passkeys',
  'betterAuth.signin.twoFactor.backToPassword': 'Back',
  'betterAuth.signin.twoFactor.backupCode.label': 'Recovery code',
  'betterAuth.signin.twoFactor.backupCode.placeholder': 'Enter a recovery code',
  'betterAuth.signin.twoFactor.backupCode.subtitle':
    'Enter one of the recovery codes you saved when you turned on two-step verification. Each code works once.',
  'betterAuth.signin.twoFactor.backupCode.title': 'Use a recovery code',
  'betterAuth.signin.twoFactor.code.label': 'Verification code',
  'betterAuth.signin.twoFactor.code.placeholder': '6-digit code',
  'betterAuth.signin.twoFactor.error': 'That code is incorrect or has expired',
  'betterAuth.signin.twoFactor.submit': 'Verify',
  'betterAuth.signin.twoFactor.subtitle': 'Enter the 6-digit code from your authenticator app',
  'betterAuth.signin.twoFactor.title': 'Two-step verification',
  'betterAuth.signin.twoFactor.trustDevice': 'Trust this device for 30 days',
  'betterAuth.signin.twoFactor.useBackupCode': 'Use a recovery code instead',
  'betterAuth.signin.twoFactor.useTotp': 'Use your authenticator code instead',
  ...
  'profile.save': 'Save',
  'profile.security.close': 'Close',
  'profile.security.error.noPasswordAccount': 'This account does not use a password',
  'profile.security.error.passkeyAlreadyRegistered': 'This passkey is already registered',
  'profile.security.error.passkeyNotFound': 'This passkey no longer exists',
  'profile.security.error.passwordTooLong': 'New password is too long',
  'profile.security.error.passwordTooShort': 'New password is too short',
  'profile.security.error.reauthRequired': 'Sign in again to continue',
  'profile.security.error.sessionExpired': 'Session expired. Sign in again',
  'profile.security.error.tooManyAttempts': 'Too many attempts. Request a new code',
  'profile.security.error.tooManyRequests': 'Too many requests. Try again later',
  'profile.security.passkey.add': 'Add a passkey',
  'profile.security.passkey.added': 'Passkey added',
  'profile.security.passkey.cancelled': 'Cancelled',
  'profile.security.passkey.createdAt': 'Added {{date}}',
  'profile.security.passkey.desc': "Sign in with your device's fingerprint, face or PIN.",
  'profile.security.passkey.empty': 'No passkeys yet',
  'profile.security.passkey.error': 'Could not add passkey. Try again.',
  'profile.security.passkey.nameLabel': 'Name',
  'profile.security.passkey.namePlaceholder': 'e.g. My MacBook',
  'profile.security.passkey.remove': 'Remove',
  'profile.security.passkey.removeConfirm': 'This passkey will no longer work for signing in.',
  'profile.security.passkey.removeTitle': 'Remove {{name}}?',
  'profile.security.passkey.removed': 'Passkey removed',
  'profile.security.passkey.rename': 'Rename',
  'profile.security.passkey.renameTitle': 'Rename passkey',
  'profile.security.passkey.title': 'Passkeys',
  'profile.security.passkey.unsupported': 'This browser does not support passkeys',
  'profile.security.password.action': 'Change password',
  'profile.security.password.confirmLabel': 'Confirm new password',
  'profile.security.password.currentLabel': 'Current password',
  'profile.security.password.incorrect': 'Current password is incorrect',
  'profile.security.password.mismatch': 'New passwords do not match',
  'profile.security.password.newLabel': 'New password',
  'profile.security.password.reuse': 'New password must be different from the current one',
  'profile.security.password.revokeOthers': 'Sign out other devices',
  'profile.security.password.rule': 'At least {{min}} characters',
  'profile.security.password.submit': 'Change password',
  'profile.security.password.success': 'Password changed',
  'profile.security.password.title': 'Change password',
  'profile.security.password.useEmailReset': 'Reset by email',
  'profile.security.status.both': 'Two-step verification on · Passkey',
  'profile.security.status.passkey': 'Passkey added',
  'profile.security.status.unavailable': 'Security status unavailable',
  'profile.security.twoFactor.action': 'Two-step verification',
  'profile.security.twoFactor.backupCodes.copied': 'Recovery codes copied',
  'profile.security.twoFactor.backupCodes.copy': 'Copy',
  'profile.security.twoFactor.backupCodes.desc':
    'Each code works once. Keep them somewhere safe in case your authenticator is unavailable.',
  'profile.security.twoFactor.backupCodes.done': 'I have saved them',
  'profile.security.twoFactor.backupCodes.download': 'Download',
  'profile.security.twoFactor.backupCodes.regenerate': 'Generate new codes',
  'profile.security.twoFactor.backupCodes.regenerateHint':
    'Generating new codes invalidates the old ones.',
  'profile.security.twoFactor.backupCodes.title': 'Recovery codes',
  'profile.security.twoFactor.ssoHint':
    'Your identity provider manages the second factor for this account.',
  'profile.security.twoFactor.status.off': 'Two-step verification off',
  'profile.security.twoFactor.status.on': 'Two-step verification on',
  'profile.security.twoFactor.status.unsupported': 'Two-step verification unavailable',
  'profile.security.twoFactor.subtitle': 'Adds a second verification step at sign-in.',
  'profile.security.twoFactor.title': 'Two-step verification',
  'profile.security.twoFactor.totp.codeHint': 'Enter the 6-digit code from your authenticator.',
  'profile.security.twoFactor.totp.codeLabel': '6-digit code',
  'profile.security.twoFactor.totp.desc': 'A 6-digit code from your authenticator app.',
  'profile.security.twoFactor.totp.disableConfirm': 'Turn off',
  'profile.security.twoFactor.totp.disableDesc':
    'Only your password will be required at sign-in. Recovery codes will stop working.',
  'profile.security.twoFactor.totp.disableTitle': 'Turn off two-step verification?',
  'profile.security.twoFactor.totp.disabled': 'Two-step verification is off',
  'profile.security.twoFactor.totp.enabled': 'Two-step verification is on',
  'profile.security.twoFactor.totp.invalidCode': 'That code is incorrect or has expired',
  'profile.security.twoFactor.totp.off': 'Off',
  'profile.security.twoFactor.totp.on': 'On',
  'profile.security.twoFactor.totp.passwordHint': 'Enter your current password to continue.',
  'profile.security.twoFactor.totp.scanHint':
    'Scan the QR code with your authenticator app, or enter the key manually.',
  'profile.security.twoFactor.totp.secretCopied': 'Setup key copied',
  'profile.security.twoFactor.totp.secretLabel': 'Setup key',
  'profile.security.twoFactor.totp.setUp': 'Set up',
  'profile.security.twoFactor.totp.step.confirm': 'Enter the code',
  'profile.security.twoFactor.totp.step.password': 'Confirm it is you',
  'profile.security.twoFactor.totp.step.save': 'Save recovery codes',
  'profile.security.twoFactor.totp.step.scan': 'Scan the QR code',
  'profile.security.twoFactor.totp.title': 'Authenticator app',
  'profile.security.twoFactor.totp.turnOff': 'Turn off',
  ...
  'stats.activityInRange': 'Activity · {{scope}}',
  ...
  'stats.heatmapStats.peakHourlyTokens': 'Peak Hourly Tokens',
  ...
  'stats.usersActive': 'Active users',
  'stats.usersTotal': 'Total users',
  'stats.usersRank.left': 'User',
  'stats.usersRank.metric.cost': 'Cost',
  'stats.usersRank.metric.messages': 'Messages',
  'stats.usersRank.metric.tokens': 'Tokens',
  'stats.usersRank.title': 'User Rank',
  'stats.tokens': 'Tokens',
  ...
  'usage.cards.month.titleInRange': 'Spend · {{range}}',
