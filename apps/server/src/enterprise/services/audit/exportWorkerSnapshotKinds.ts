/** Per-kind REPEATABLE READ export materialization (operation_logs / conversations / user_timeline). */
...
import { toIso } from './exportWorkerShared';

export type MaterializeSnapshotParams = {
...
export type WriteStaging = (row: Record<string, unknown>) => Promise<void>;
...
export const materializeOperationLogs = async (
  snap: LobeChatDatabase,
  params: MaterializeSnapshotParams,
  writeStaging: WriteStaging,
): Promise<void> => {
...
export const materializeConversations = async (
  snap: LobeChatDatabase,
  params: MaterializeSnapshotParams,
  writeStaging: WriteStaging,
): Promise<void> => {
...
export const materializeUserTimeline = async (
  snap: LobeChatDatabase,
  params: MaterializeSnapshotParams,
  writeStaging: WriteStaging,
): Promise<void> => {
