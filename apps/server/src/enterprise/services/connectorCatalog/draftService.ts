...
import type { PlatformConnectorItem } from '@/database/schemas/platform';
import {
...
import { clearConnectorConnectionTest } from './connectionTestState';
import {
  assertStoredSecret,
  connectorDraftToken,
  ...
  currentSlot,
  loadConnectorDraft,
  loadConnectorDraftsBatch,
  loadTrustedSecretContextSafe,
  type PersistedSecretSlots,
  toDraft,
  toSlotColumns,
} from './draftProjection';
