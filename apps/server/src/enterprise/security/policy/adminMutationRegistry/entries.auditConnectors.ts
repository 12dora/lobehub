...
export const ADMIN_MUTATION_ENTRIES_AUDIT_CONNECTORS = {
  ...
  'admin.connectors.applyImmediate': dangerousMutation(
    ...
    { outbound: safeOutbound, reason: optionalReasonInput, reauth: recentReauth },
  ),
  ...
  'admin.connectors.discover': regularMutation(
    ...
    { lastKnownGood: remoteProbeNoLkg, outbound: safeOutbound, reason: optionalReasonInput },
  ),
  ...
  'admin.branding.uploadAsset': regularMutation(
    ...
    { lastKnownGood: assetNoLkg, reason: optionalReasonInput },
  ),
