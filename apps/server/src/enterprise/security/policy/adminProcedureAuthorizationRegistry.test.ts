...
describe('admin procedure authorization registry', () => {
  it('reconciles all live procedures, middleware gates, root mounts, and mutation risks', () => {
    ...
    // Prior baseline 119 + W10-S stats (12 queries) + W10-E creds (5 queries + 7 mutations) = 143
    expect(ADMIN_PROCEDURE_AUTHORIZATION_REGISTRY).toHaveLength(143);
    expect(
    ...
    expect(mutationPaths).toHaveLength(78);
