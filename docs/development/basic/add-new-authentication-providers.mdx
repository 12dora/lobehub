...
description: Learn how to implement a new authentication provider using Better Auth in LobeHub.
tags:
  - Authentication
  - Better Auth
  - LobeHub
...
- **Generic OAuth providers**: `https://yourdomain.com/api/auth/oauth2/callback/{providerId}`
