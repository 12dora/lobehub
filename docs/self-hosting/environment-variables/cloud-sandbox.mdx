...
The image is `python:3.12-slim` plus Node 22, git, curl, a compiler toolchain, and common data/document Python libraries. Default working directory is `/mnt/data`.
