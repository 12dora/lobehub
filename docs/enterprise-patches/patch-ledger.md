...
| `src/libs/redis/{manager,redis}.ts`                                                                      | Bounded Redis initialization, cleanup and secret-free error handling | M14    | W8    | Failed initialization owns and closes retry timers/sockets; only error class is logged     |
