# Code review — "slim" batch (deployment slimming / optional modules), package: G3
...
Files in scope for G3:
The file set owned by G3 in audit/slim-2026-08-17/prompts/COMMON_RULES.md ("Ownership" section) plus every file listed in the author's report. Use `git status --short` and `git diff HEAD -- <paths>` in the repo to see them; new files are untracked (read them whole).

Package brief (what the author was asked to do): audit/slim-2026-08-17/prompts/G3_upstream_routers.md
Author's report: audit/slim-2026-08-17/reports/G3.md
...
Write your review to audit/slim-2026-08-17/reviews/REVIEW_G3.md (create it) and also print it as your final message.
