# Code review — "slim" batch (deployment slimming / optional modules), package: F1
...
Files in scope for F1:
The file set owned by F1 in audit/slim-2026-08-17/prompts/COMMON_RULES.md ("Ownership" section) plus every file listed in the author's report. Use `git status --short` and `git diff HEAD -- <paths>` in the repo to see them; new files are untracked (read them whole).

Package brief (what the author was asked to do): audit/slim-2026-08-17/prompts/F1_admin_modules_ui.md
Author's report: audit/slim-2026-08-17/reports/F1.md
