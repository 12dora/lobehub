# Code review — "slim" batch (deployment slimming / optional modules), package: G1
...
Files in scope for G1:
The file set owned by G1 in audit/slim-2026-08-17/prompts/COMMON_RULES.md ("Ownership" section) plus every file listed in the author's report. Use `git status --short` and `git diff HEAD -- <paths>` in the repo to see them; new files are untracked (read them whole).

Package brief (what the author was asked to do): audit/slim-2026-08-17/prompts/G1_module_core.md
Author's report: audit/slim-2026-08-17/reports/G1.md
