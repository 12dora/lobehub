...
interface SettingContentProps {
  /**
   * Surface-specific override for the delete confirmation body (admin platform catalog, where a
   * delete is site-wide and purges credentials plus version history). Absent = normal user copy.
   */
...
const SettingContent = memo<SettingContentProps>(
  ({ initialValues, id, deleteConfirmDescription }) => {
    ...
    const handleDelete = () => {
      confirmModal({
        content: deleteConfirmDescription ?? t('updateAiProvider.confirmDeleteDescription'),
