  ...
  ({ catalog, config, disabled, onModeChange, onPatch }) => {
    ...
    return (
      ...
      >
        ...
        <Field
          ...
          hint={
            <span data-testid="block-message-counter">
              {t('contentModeration.settings.basic.blockMessageHint')} ·{' '}
        ...
        <Field
          ...
          hint={
            <span data-testid="downgrade-message-counter">
              {t('contentModeration.settings.basic.downgradeMessageHint')} ·{' '}
              {t('contentModeration.settings.basic.charCount', {
        ...
        <Field label={t('contentModeration.settings.basic.showCategory')}>
          <div className={styles.toolbarRow}>
            ...
            <span className={styles.hintText}>
              {t('contentModeration.settings.basic.showCategoryHint')}
            </span>
          </div>
        </Field>
        ...
        <Field
          ...
          hint={
            config.downgrade
              ? t('contentModeration.settings.basic.downgradeModelHint')
