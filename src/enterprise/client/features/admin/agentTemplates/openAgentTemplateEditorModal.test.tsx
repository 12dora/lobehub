...
vi.mock('./AgentTemplateEditorForm', () => ({
...
const item: AdminAgentTemplateItem = {
  avatar: null,
...
const renderModal = async (props: Record<string, unknown>) => {
  const { openAgentTemplateEditorModal } = await import('./openAgentTemplateEditorModal');
  const config = openAgentTemplateEditorModal(props as never) as unknown as { content: ReactNode };
...
describe('openAgentTemplateEditorModal', () => {
