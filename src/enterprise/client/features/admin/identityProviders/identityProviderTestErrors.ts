...
const IDENTITY_PROVIDER_TEST_ERROR_KEYS = new Map<string, string>(
  Object.entries({
    ...
    OIDC_TEST_EXPIRED: 'identityProviders.test.errors.expired',
    OIDC_TEST_FAILED: 'identityProviders.test.errors.failed',
    OIDC_TEST_ID_TOKEN_INVALID: 'identityProviders.test.errors.idTokenInvalid',
    OIDC_TEST_INVALID_STATE: 'identityProviders.test.errors.invalidState',
